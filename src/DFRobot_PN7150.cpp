/*!
 * @file DFRobot_PN7150.cpp
 * @brief Implementation of DFRobot_PN7150 class
...
bool DFRobot_PN7150::NxpNci_CheckDevPres(void)
{
...
bool DFRobot_PN7150::NxpNci_WaitForReception(uint8_t* pRBuff, uint16_t RBuffSize, uint16_t* pBytesread, uint16_t timeout)
{
...
bool DFRobot_PN7150::NxpNci_HostTransceive(uint8_t* pTBuff, uint16_t TbuffLen, uint8_t* pRBuff, uint16_t RBuffSize, uint16_t* pBytesread)
{
...
void DFRobot_PN7150::NxpNci_FillInterfaceInfo(NxpNci_RfIntf_t* pRfIntf, uint8_t* pBuf)
{
    uint8_t i, temp;
...
bool DFRobot_PN7150::NxpNci_CardModeReceive(unsigned char* pData, unsigned char* pDataSize)
{
...
bool DFRobot_PN7150::NxpNci_CardModeSend(unsigned char* pData, unsigned char DataSize)
{
    bool status;
    uint8_t Cmd[MAX_NCI_FRAME_SIZE];
    uint8_t Ans[MAX_NCI_FRAME_SIZE];
...
#ifdef P2P_SUPPORT
void DFRobot_PN7150::NxpNci_ProcessP2pMode(NxpNci_RfIntf_t RfIntf)
{
    uint8_t Answer[MAX_NCI_FRAME_SIZE];
    uint16_t AnswerSize;
    bool status;
...
#ifdef RW_SUPPORT
bool DFRobot_PN7150::NxpNci_ReaderTagCmd(unsigned char* pCommand, unsigned char CommandSize, unsigned char* pAnswer, unsigned char* pAnswerSize)
{
    bool status = NXPNCI_ERROR;
    uint8_t Cmd[MAX_NCI_FRAME_SIZE];
    uint8_t Ans[MAX_NCI_FRAME_SIZE];
...
void DFRobot_PN7150::NxpNci_ReadNdef(NxpNci_RfIntf_t RfIntf)
{
    uint8_t Answer[MAX_NCI_FRAME_SIZE];
    uint16_t AnswerSize;
    uint8_t Cmd[MAX_NCI_FRAME_SIZE];
...
void DFRobot_PN7150::NxpNci_WriteNdef(NxpNci_RfIntf_t RfIntf)
{
    uint8_t Answer[MAX_NCI_FRAME_SIZE];
    uint16_t AnswerSize;
    uint8_t Cmd[MAX_NCI_FRAME_SIZE];
...
void DFRobot_PN7150::NxpNci_PresenceCheck(NxpNci_RfIntf_t RfIntf)
{
    bool status;
    uint8_t i;
    uint8_t Answer[MAX_NCI_FRAME_SIZE];
...
void DFRobot_PN7150::NxpNci_ProcessReaderMode(NxpNci_RfIntf_t RfIntf, NxpNci_RW_Operation_t Operation)
{
#ifndef NO_NDEF_SUPPORT
...
bool DFRobot_PN7150::NxpNci_ReaderActivateNext(NxpNci_RfIntf_t* pRfIntf)
{
...
bool DFRobot_PN7150::NxpNci_ReaderReActivate(NxpNci_RfIntf_t* pRfIntf)
{
    uint8_t NCIDeactivate[] = { 0x21, 0x06, 0x01, 0x01 };
...
bool DFRobot_PN7150::NxpNci_Connect(void)
{
    uint8_t i = 2;
...
void DFRobot_PN7150::NxpNci_GetFwVersion(unsigned char fw[3])
{
...
bool DFRobot_PN7150::NxpNci_Disconnect(void)
{
...
bool DFRobot_PN7150::NxpNci_ConfigureSettings(void)
{
    uint8_t Answer[MAX_NCI_FRAME_SIZE];
    uint16_t AnswerSize;
...
bool DFRobot_PN7150::NxpNci_ConfigureParams(unsigned char* pCmd, unsigned short CmdSize)
{
    uint8_t Answer[MAX_NCI_FRAME_SIZE];
    uint16_t AnswerSize;
...
bool DFRobot_PN7150::NxpNci_StopDiscovery(void)
{
    uint8_t NCIStopDiscovery[] = { 0x21, 0x06, 0x01, 0x00 };
    uint8_t Answer[MAX_NCI_FRAME_SIZE];
    uint16_t AnswerSize;
...
bool DFRobot_PN7150::NxpNci_WaitForDiscoveryNotification(NxpNci_RfIntf_t* pRfIntf)
{
...
bool DFRobot_PN7150::NxpNci_FactoryTest_Prbs(NxpNci_TechType_t type, NxpNci_Bitrate_t bitrate)
{
...
bool DFRobot_PN7150::NxpNci_FactoryTest_RfOn(void)
{
...
DFRobot_PN7150_I2C::DFRobot_PN7150_I2C(TwoWire* pWire, uint8_t i2cAddr)
{
    _pWire = pWire;
    _deviceAddr = i2cAddr;
}
...
DFRobot_PN7150_I2C::Status DFRobot_PN7150_I2C::tml_DeInit(void)
{
...
DFRobot_PN7150_I2C::Status DFRobot_PN7150_I2C::tml_Rx(uint8_t* pBuff, uint16_t buffLen, uint16_t* pBytesRead)
{
...
void DFRobot_PN7150_I2C::tml_Disconnect(void)
{
    tml_DeInit();
}

void DFRobot_PN7150_I2C::tml_Send(uint8_t* pBuffer, uint16_t BufferLen, uint16_t* pBytesSent)
{
